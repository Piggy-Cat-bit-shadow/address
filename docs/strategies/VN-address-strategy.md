...
| 验证 / 排除 | 2025 官方 PDF 本地解析出 34 个省级单位、3,319 条有效记录；9 组同省同名对应多个邮编的 18 条记录不补全，1 条上游 `#VALUE!` 忽略。仅省级单位 + 坊/社唯一匹配时补邮编；Vpostcode 与 Overture 不接入。 |
| 策略版本 / 状态 / 更新 | 1.7 / 现行两级行政体系 + 官方唯一邮编映射 + 多规则完成下限 / 2026-08-02 |
