    ...
    <header className="topbar">
      ...
      <nav className="top-links">
        ...
        <a className="admin-link" href="/admin/" aria-label="Admin">
          <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 8.25A3.75 3.75 0 1 0 12 15.75 3.75 3.75 0 0 0 12 8.25Zm0 6A2.25 2.25 0 1 1 12 9.75a2.25 2.25 0 0 1 0 4.5Zm8.2-3.25-1.61-.62a7.2 7.2 0 0 0-.52-1.25l.7-1.58-2.32-2.32-1.58.7a7.2 7.2 0 0 0-1.25-.52L13 3.8h-2l-.62 1.61c-.43.14-.85.32-1.25.52l-1.58-.7-2.32 2.32.7 1.58c-.2.4-.38.82-.52 1.25L3.8 11v2l1.61.62c.14.43.32.85.52 1.25l-.7 1.58 2.32 2.32 1.58-.7c.4.2.82.38 1.25.52L11 20.2h2l.62-1.61c.43-.14.85-.32 1.25-.52l1.58.7 2.32-2.32-.7-1.58c.2-.4.38-.82.52-1.25L20.2 13v-2Zm-1.5.97v.06l-1.34.52-.13.49a5.7 5.7 0 0 1-.65 1.56l-.26.44.58 1.31-.55.55-1.31-.58-.44.26a5.7 5.7 0 0 1-1.56.65l-.49.13-.52 1.34h-.06l-.52-1.34-.49-.13a5.7 5.7 0 0 1-1.56-.65l-.44-.26-1.31.58-.55-.55.58-1.31-.26-.44a5.7 5.7 0 0 1-.65-1.56l-.13-.49-1.34-.52v-.06l1.34-.52.13-.49c.15-.55.37-1.07.65-1.56l.26-.44-.58-1.31.55-.55 1.31.58.44-.26a5.7 5.7 0 0 1 1.56-.65l.49-.13.52-1.34h.06l.52 1.34.49.13c.55.15 1.07.37 1.56.65l.44.26 1.31-.58.55.55-.58 1.31.26.44c.28.49.5 1.01.65 1.56l.13.49 1.34.52Z"/></svg>
        </a>
